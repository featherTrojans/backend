        ...
        if (userUid && userUid != null) {
            ...
            if ( !check ) {
                ...
                if ( !uploadPayment ) {
                    ...
                    //credit user
                    services.creditService({userUid, reference, amount, description: originator_narration,from: `${originator_account_name} - ${originator_account_number}`, to: "primary wallet", type: "Vfd Funding" })
