    ...
    try{
        if (!errors.isEmpty()) {
            ...
            return res.status(400).json({
                status : false,
                data: {},
                message: "Aww padi! Kindly Input your phone number to register"
            })
            ...
            if ( checkUsername != null) {
                return res.status(404).json({
                    status : false,
                    data: {},
                    message: "Aww padi! Phone number already used"
                })
            } else {
                ...
                Users.create({
                    ...
                    const token = TokenServices({userId, username}, '262800h')
