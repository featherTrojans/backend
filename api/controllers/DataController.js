...
exports.buyAirtime = ( async (req, res) => {
    ...
    const { phone, network, amount, userPin, value } = req.body
    ...
    try{
        ...
        dataToGB = value/1000 >= 1 ? value/1000 + "GB" : value + "MB";
        // get level details
        ...
        if (verifyPin != true ) {
            ...
            return res.status(400).json({
                ...
                message: "Cannot purchase data at the moment because your balance is not enough "
            ...
            if (insert) {
                new Promise(function(resolve, reject) {
                    ...
                    NewBills.create({
                        ...
                        transId: reference,
                        network,
                        description: `NGN${amount} (${value}) ${network} data purchased on ${phone}`
                    }).then(()=> {

                        buyData({phone: "08012345678", network: "9mobile", amount, type: "data", value, trans_id: reference}).then((buyAirtime) => {
